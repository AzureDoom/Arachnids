...
public class ProjectilesEntityRegister {
  ...
  public static List<EntityType<? extends Entity>> ENTITY_TYPES =
      new LinkedList();
  public static List<EntityType<? extends Entity>>
      ENTITY_THAT_USE_ITEM_RENDERS = new LinkedList();

  public static EntityType<BulletEntity> BULLETS =
      projectile(BulletEntity::new, "762");
  public static EntityType<TacticalOxygenNukeEntity> TON =
      projectile(TacticalOxygenNukeEntity::new, "ton");
  public static EntityType<MZ90Entity> MZ90 =
      projectile(MZ90Entity::new, "mz90");
  public static EntityType<BugPlasmaEntity> BUGPLASMA =
      projectile(BugPlasmaEntity::new, "bugplasma");
  public static EntityType<FlareEntity> FLARE =
      projectile(FlareEntity::new, "flare");

  private static <T extends Entity> EntityType<T>
  projectile(EntityType.EntityFactory<T> factory, String id) {
  ...
  projectile(EntityType.EntityFactory<T> factory, String id,
    ...
    Registry.register(Registry.ENTITY_TYPE,
                      new Identifier(ArachnidsMod.MODID, id), type);
