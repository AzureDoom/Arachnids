...
public class ArachnidsMobs {
	...
	public static final EntityType<ArkellianEntity> ARKELLIANBUG = Registry.register(Registry.ENTITY_TYPE,
			...
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ArkellianEntity::new)
					.dimensions(EntityDimensions.changing(1.1f, 0.85F)).trackRangeBlocks(90).trackedUpdateRate(4)
					.build());
	...
	public static final EntityType<ScorpionEntity> SCORPIONBUG = Registry.register(Registry.ENTITY_TYPE,
			...
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ScorpionEntity::new)
					.dimensions(EntityDimensions.changing(12.05f, 8.25F)).trackRangeBlocks(90).trackedUpdateRate(4).build());
	...
	public static final EntityType<TankerEntity> TANKERBUG = Registry.register(Registry.ENTITY_TYPE,
			...
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, TankerEntity::new)
					.dimensions(EntityDimensions.changing(12.6f, 4.95F)).trackRangeBlocks(90).trackedUpdateRate(4)
					.build());
