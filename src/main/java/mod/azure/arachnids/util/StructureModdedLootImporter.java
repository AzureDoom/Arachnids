...
import mod.azure.arachnids.mixin.BuilderAccessor;
import mod.azure.arachnids.mixin.LootContextAccessor;
import mod.azure.arachnids.mixin.LootManagerAccessor;
...
public class StructureModdedLootImporter {
	...
	private static Map<Identifier, Identifier> createMap() {
		...
		tableMap.put(new Identifier("minecraft:chests/abandoned_mineshaft"),
				new Identifier(ArachnidsMod.MODID, "chests/abandoned_mineshaft"));
		tableMap.put(new Identifier("minecraft:chests/desert_pyramid"),
				new Identifier(ArachnidsMod.MODID, "chests/desert_pyramid"));
		tableMap.put(new Identifier("minecraft:chests/pillager_outpost"),
				new Identifier(ArachnidsMod.MODID, "chests/pillager_outpost"));
		tableMap.put(new Identifier("minecraft:chests/shipwreck_supply"),
				new Identifier(ArachnidsMod.MODID, "chests/shipwreck_supply"));
		tableMap.put(new Identifier("minecraft:chests/shipwreck_treasure"),
				new Identifier(ArachnidsMod.MODID, "chests/shipwreck_treasure"));
		tableMap.put(new Identifier("minecraft:chests/spawn_bonus_chest"),
				new Identifier(ArachnidsMod.MODID, "chests/spawn_bonus_chest"));
		return tableMap;
	}
