 ...
 * */
public class BugNavigation extends GroundPathNavigation {

	public BugNavigation(BaseBugEntity entity, Level world) {
		super(entity, world);
	}
	...
	protected PathFinder createPathFinder(int maxVisitedNodes) {
		...
		return new BugPathFinder(this.nodeEvaluator, maxVisitedNodes);
	}
