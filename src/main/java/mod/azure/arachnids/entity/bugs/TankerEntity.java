...
public class TankerEntity extends BaseBugEntity {
	...
	public TankerEntity(EntityType<? extends BaseBugEntity> entityType, World world) {
		super(entityType, world);
		this.experiencePoints = config.tanker_exp;
	}
	...
	public static boolean canSpawn(EntityType<TankerEntity> type, WorldAccess world, SpawnReason reason, BlockPos pos,
	...
	public static DefaultAttributeContainer.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(EntityAttributes.GENERIC_FOLLOW_RANGE, 25.0D)
				.add(EntityAttributes.GENERIC_MAX_HEALTH, config.tanker_health)
				.add(EntityAttributes.GENERIC_ATTACK_DAMAGE, config.tanker_melee)
