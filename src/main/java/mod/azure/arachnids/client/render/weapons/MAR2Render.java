...
public class MAR2Render extends GeoItemRenderer<MAR2Item> {
	...
	@Override
	public void renderRecursively(PoseStack poseStack, MAR2Item animatable, GeoBone bone, RenderType renderType,
		...
		if (bone.getName().equals("scope")) {
			bone.setHidden(
					EnchantmentHelper.getEnchantments(currentItemStack).containsKey(ArachnidsMod.SNIPERATTACHMENT) ? false : true);
		}
		super.renderRecursively(poseStack, animatable, bone, renderType, bufferSource, buffer, skipGeoLayers, partialTick,
