...
public class MZ90Render extends GeoEntityRenderer<MZ90Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MZ90Entity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
